...
function_shortcode(){
	...
	<div class="form-group" >
		...
		<input type="text" class="form-control" id="name" placeholder="Enter Name"  style="width:100%;">
	  </div>
	  
	  <div class="form-group" style="margin-top:6px;">
		
		<input type="text" class="form-control" id="website" aria- placeholder="Enter Website Url"  style="width:100%;">
		
	  </div>
	  
	  
	  <button type="submit" class="btn btn-primary" style="margin:6px;; ">Submit</button>
	</form> ";
	return $form;
}
add_shortcode('hello','_shortcode');